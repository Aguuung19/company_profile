<div class="d-block d-sm-block d-xs-block d-md-block d-lg-none">
    <div id="sidebar" class="collapse collapse-horizontal show">
        <div id="sidebar-nav" class="list-group text-sm-start">
            <a href="#sidebar-collapse" class="list-group-item d-inline-block text-truncate" data-bs-parent="#sidebar" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebar-collapse"><span>{{Auth::user()->name}}</span><span class="me-auto bi bi-caret-down-fill"></span> </a>
            <div class="collapse menu-profile" id="sidebar-collapse">
                    <hr>
                <form action="{{url('/logout')}}" method="post">
                        @csrf
                        <button class="text-danger btn" type="submit">Logout</button>
                    </form>
            </div>
        </div>
    </div>
...
<div id="sidebar" class="collapse collapse-horizontal show">
    <div id="sidebar-nav" class="list-group text-sm-start">
        ...
        <a href="#" class="list-group-item d-inline-block text-truncate" data-bs-parent="#sidebar"><i class="bi bi-view-list"></i> <span>Landing Page Setting</span></a>
        ...
        <a href="#master-collapse" class="list-group-item d-inline-block text-truncate" data-bs-parent="#sidebar" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="master-collapse"><i class="bi bi-cpu-fill"></i> <span>Master Data</span><span class="me-auto bi bi-caret-down-fill"></span> </a>
